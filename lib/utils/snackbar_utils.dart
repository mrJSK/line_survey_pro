    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: isError
            ? Colors.red.shade700 // Red background for error messages.
            : Colors
                .green.shade700, // Green background for success/info messages.
        ...
        shape: RoundedRectangleBorder(
            borderRadius:
                BorderRadius.circular(8)), // Rounded corners for styling.
