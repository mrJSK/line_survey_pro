...
class FirestoreService {
  ...
  static String get _basePath {
    ...
    // If you intend to use the 'artifacts/$appId/public/data' path,
    // you MUST move your 'transmissionLines' collection inside it in the Firebase console.
    // For now, let's assume 'transmissionLines' is directly at the root.

    // Option 1: If 'transmissionLines' is DIRECTLY at the root (as your screenshot implies)
    return ''; // Empty string means the collection is at the database root

    // Option 2: If you want to use the 'artifacts' structure, you must manually move
