...
import 'package:line_survey_pro/screens/line_patrolling_details_screen.dart'; // For line patrolling details navigation
...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  Map<String, WorkerProgressSummary> _getWorkerProgressSummaries() {
    ...
    final allApprovedWorkers = widget.allUsersInSystem
        .where((user) => user.role == 'Worker' && user.status == 'approved')
        .toList();
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Progress by Worker (Visible for Admin and Manager)
